...
namespace Naninovel.UI
{
    ...
    /// </remarks>
    public class c_RevealableTextPrinterPanel : UITextPrinterPanel, ILocalizableUI
    {
        [Serializable]
        ...
        protected override void Awake ()
        {
            ...
            namePanel = AuthorNamePanel.GetComponent<Image>();
            defaultNameColor = namePanel ? namePanel.color : default;
        ...
        protected virtual void SetMessageAuthor (MessageAuthor author)
        {
            ...
            if (AuthorNamePanel)
                //AuthorNamePanel = AuthorMeta.UseCharacterColor ? AuthorMeta.NameColor : defaultNameColor;
                namePanel.color = AuthorMeta.UseCharacterColor ? AuthorMeta.NameColor : defaultNameColor;
